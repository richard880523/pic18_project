...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=setting_hardaware/setting.c setting_hardaware/uart.c setting_hardaware/interrupt_manager.c setting_hardaware/ccp1.c setting_hardaware/adc.c ADC_Source_File.c PIC_DC_Motor.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/setting_hardaware/setting.p1 ${OBJECTDIR}/setting_hardaware/uart.p1 ${OBJECTDIR}/setting_hardaware/interrupt_manager.p1 ${OBJECTDIR}/setting_hardaware/ccp1.p1 ${OBJECTDIR}/setting_hardaware/adc.p1 ${OBJECTDIR}/ADC_Source_File.p1 ${OBJECTDIR}/PIC_DC_Motor.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/setting_hardaware/setting.p1.d ${OBJECTDIR}/setting_hardaware/uart.p1.d ${OBJECTDIR}/setting_hardaware/interrupt_manager.p1.d ${OBJECTDIR}/setting_hardaware/ccp1.p1.d ${OBJECTDIR}/setting_hardaware/adc.p1.d ${OBJECTDIR}/ADC_Source_File.p1.d ${OBJECTDIR}/PIC_DC_Motor.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/setting_hardaware/setting.p1 ${OBJECTDIR}/setting_hardaware/uart.p1 ${OBJECTDIR}/setting_hardaware/interrupt_manager.p1 ${OBJECTDIR}/setting_hardaware/ccp1.p1 ${OBJECTDIR}/setting_hardaware/adc.p1 ${OBJECTDIR}/ADC_Source_File.p1 ${OBJECTDIR}/PIC_DC_Motor.p1

# Source Files
SOURCEFILES=setting_hardaware/setting.c setting_hardaware/uart.c setting_hardaware/interrupt_manager.c setting_hardaware/ccp1.c setting_hardaware/adc.c ADC_Source_File.c PIC_DC_Motor.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -mrom=default,-7dc0-7fff -mram=default,-5f4-5ff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/lab11_2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
